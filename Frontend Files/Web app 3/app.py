...
def inputs_block_match_winner():
    st.markdown('<div class="info-box">Select the home team, away team, and their previous season league ranks to predict the match outcome.</div>', unsafe_allow_html=True)
    st.markdown(
